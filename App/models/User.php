    ...
    public function addUSER($data)
    {
        ...
        if (!empty($hasilEmail['user']['email']) > 0) {
            ...
            if ($ex != "jpg" && $ex != "png" && $ex != "jpeg") {
                ...
                $query = "INSERT INTO " . $this->table . " VALUES ('', :nama, :password, :username, :email, :foto, :nohp, :alamat, :level, :type, :facebook, :instagram, :pekerjaan)";
                ...
                $this->db->bind('facebook', null);
                $this->db->bind('instagram', null);
                $this->db->bind('pekerjaan', null);
